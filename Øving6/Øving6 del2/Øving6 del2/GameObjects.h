...
public:
	...
	void incrementAngle(double dtheta = 450);      // increment the angle of the cannon by dtheta
	void decrementAngle(double dtheta = 450);      // decrement the angle of the cannon by dtheta
...
class Cannonball {
	double size = 5; // radius of cannonball
